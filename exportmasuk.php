...
<div class="container">
            ...
            <a href="masuk.php" class="btn btn-danger" style="margin-bottom: 20px;">Kembali</a>
                ...
                <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                                        ...
                                        <div>
                                                <?php
                                                $ambilsemuadatamasukdanstock = mysqli_query($conn, "SELECT m.*, s.namabarang 
                                                    FROM masuk m
                                                    JOIN stock s ON m.idbarang = s.idbarang
                                                    ORDER BY m.tanggal DESC");
                                                $i = 1;
                                                while ($data = mysqli_fetch_array($ambilsemuadatamasukdanstock)) {
